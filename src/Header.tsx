        ...
        <>
            <div className="h-16 w-full glass overflow-hidden shadow-sm shadow-zinc-700">
                <nav className="h-full w-full lg:px-2 glass3 flex items-center justify-between">
                    <div className="lg:px-4 h-36 w-36 lg:h-44 lg:w-44 px-1"><img src="https://media.discordapp.net/attachments/933654325127938101/1063322834081951805/42.png" className="mt-3.5 w-full h-full cursor-pointer hover:scale-110 transition ease-in-out"></img></div>
